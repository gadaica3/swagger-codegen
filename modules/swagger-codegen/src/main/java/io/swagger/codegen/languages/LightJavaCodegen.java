...
public class LightJavaCodegen extends AbstractJavaCodegen {
    ...
    public void processOpts() {
        ...
        // configuration files
        supportingFiles.add(new SupportingFile("server.mustache", ("src.main.resources.config").replace(".", java.io.File.separator), "server.yml"));
        supportingFiles.add(new SupportingFile("security.mustache", ("src.main.resources.config").replace(".", java.io.File.separator), "security.yml"));
        supportingFiles.add(new SupportingFile("secret.mustache", ("src.main.resources.config").replace(".", java.io.File.separator), "secret.yml"));
        ...
        supportingFiles.add(new SupportingFile("server.keystore", ("src.main.resources.config.tls").replace(".", java.io.File.separator), "server.keystore"));
        supportingFiles.add(new SupportingFile("server.truststore", ("src.main.resources.config.tls").replace(".", java.io.File.separator), "server.truststore"));
